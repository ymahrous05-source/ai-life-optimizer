...
export default function LifeScoreOrb({ result }: LifeScoreOrbProps) {
  ...
  return (
    <div data-tour="life-score" className="flex flex-col items-center rounded-deck border border-deck-line bg-deck-surface p-5 shadow-panel">
      <p className="mb-3 flex items-center font-display text-xs font-semibold uppercase tracking-wider text-ink-muted">
        Life Score
        <InfoTooltip text="مقياس توازن يومك (من 100)، يرتفع مع إنجاز المهام والحفاظ على استراحاتك، وينخفض عند تراكم المهام أو الإرهاق." />
      </p>
