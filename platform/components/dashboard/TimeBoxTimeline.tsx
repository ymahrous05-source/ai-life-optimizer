...
export default function TimeBoxTimeline({
  ...
  return (
    <div data-tour="timeline" className="overflow-hidden rounded-deck border border-deck-line bg-deck-surface shadow-panel">
      ...
      {isEmpty ? (
        <div className="flex flex-col items-center justify-center gap-3 px-6 py-16 text-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-full border border-energy-peak/40 bg-energy-peak/10">
            <svg viewBox="0 0 24 24" className="h-6 w-6 text-energy-peak" fill="none" stroke="currentColor" strokeWidth={1.6}>
          ...
          <p dir="rtl" className="font-body text-sm font-medium text-ink-primary">
            جدولك فارغ حالياً!
          </p>
          <p dir="rtl" className="max-w-xs font-body text-xs leading-relaxed text-ink-muted">
            اضغط على زر الميكروفون بالأسفل وقول مثلاً: <span className="text-ink-primary">&quot;عندي مذاكرة ساعة 5&quot;</span>
          </p>
        </div>
      ) : (
