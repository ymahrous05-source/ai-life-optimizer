...
export default function CostOfDelayTicker({
  ...
  return (
    <div data-tour="cost-of-delay" className="rounded-deck border border-deck-line bg-deck-surface p-4 shadow-panel">
      <p className="flex items-center font-display text-xs font-semibold uppercase tracking-wider text-ink-muted">
        Cost of Delay — Today
        <InfoTooltip text="يحسب لك التكلفة التقديرية الضائعة بسبب التأجيل لزيادة الدافعية." align="left" />
      </p>
