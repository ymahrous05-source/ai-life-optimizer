...
export default function MentalBatteryGauge({ remainingPercent }: MentalBatteryGaugeProps) {
  ...
  return (
    <div data-tour="mental-battery" className="flex flex-col items-center rounded-deck border border-deck-line bg-deck-surface p-4 shadow-panel">
      <p className="mb-2 flex items-center font-display text-xs font-semibold uppercase tracking-wider text-ink-muted">
        Mental Battery
        <InfoTooltip text="حدد مستوى طاقتك الحالية، وسيقوم الذكاء الاصطناعي بتنظيم مهامك الشاقة في أوقات ذروة نشاطك." />
      </p>
